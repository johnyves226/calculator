(function ($) {
    ...
    function themeSpecificTweaks(theme) {
        if (darkThemes.indexOf(theme) > -1) {
            ...
            $("#jazzmin-btn-css-primary").val('btn-primary').change();
            $("#jazzmin-btn-css-secondary").val('btn-secondary').change();
            $body.addClass('dark-mode');
        } else {
            $('#navbar-variants .bg-white').click();
            $("#jazzmin-btn-css-primary").val('btn-outline-primary').change();
            $("#jazzmin-btn-css-secondary").val('btn-outline-secondary').change();
    ...
    function buttonStyleListeners() {
        buttons.forEach(function(btn) {
            $("#jazzmin-btn-css-" + btn).on('change', function () {
    ...
    function setFromExisting() {
        ...
        $('#sidebar-nav-legacy-css').get(0).checked = window.ui_changes['sidebar_nav_legacy_style'];
        ...
        // set button styles
        buttons.forEach(function(btn) {
            $("#jazzmin-btn-css-" + btn).val(window.ui_changes['button_classes'][btn]);
        });
